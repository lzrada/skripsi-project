...
export default function NavbarUser() {
  ...
  const [scrolled, setScrolled] = useState(false); // ✨ shadow saat scroll
  ...
  // ── Sync wishlist dari localStorage ───────────────────────────
  useEffect(() => {
    const sync = () => {
      const uid = getCookieValue("uid");
      ...
      <nav className="relative z-999 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 h-16">
            ...
            {/* Search bar — tumbuh mengisi sisa ruang */}
                  ...
                  <>
                    ...
                    {dropdownOpen && (
                      <div
                        ...
                        style={{ zIndex: "var(--z-dropdown, 100)" } as React.CSSProperties}
                      >
                        {/* Header */}
                ...
                {isLoggedIn ? (
                  <>
                    ...
                    {[
                      { href: "/user/account", icon: faUser, label: "Profil Saya" },
                      { href: "/user/orders", icon: faBoxOpen, label: "Pesanan Saya" },
                      { href: "/user/wishlist", icon: faHeart, label: "Wishlist Saya", count: wishlistCount },
