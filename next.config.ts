...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const scriptSrc = isProd
      ? ["script-src 'self' 'unsafe-inline'", "https://app.sandbox.midtrans.com", "https://api.midtrans.com", "https://apis.google.com", "https://accounts.google.com"].join(" ")
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "frame-src https://app.sandbox.midtrans.com https://api.midtrans.com https://accounts.google.com https://*.firebaseapp.com https://*.firebase.com",
