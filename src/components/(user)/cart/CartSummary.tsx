...
import { faShield, faTruck, faTag, faTicket } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-3">
        ...
        <div className="border-t border-gray-100 pt-3">
          ...
          <Link
            ...
            className={`block w-full py-3.5 rounded-xl text-center font-black text-sm transition-all duration-200 ${selectedCount > 0 && !hasStockViolation ? "bg-[#1E2753] text-white hover:bg-[#2a3470] active:scale-95 shadow-sm" : "bg-gray-100 text-gray-400 cursor-not-allowed pointer-events-none"}`}
          >
