        ...
        <div className="flex flex-col justify-center px-6 py-8 sm:px-10 sm:py-10">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-[#1E2753] hover:bg-[#2a3470] disabled:opacity-60 disabled:cursor-not-allowed text-white rounded-2xl font-bold text-sm transition-all flex items-center justify-center gap-2 mt-2 shadow-lg shadow-blue-900/20 active:scale-95"
            >
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-xs font-medium text-slate-400 whitespace-nowrap">atau masuk dengan</span>
            <div className="flex-1 h-px bg-slate-200" />
          </div>
