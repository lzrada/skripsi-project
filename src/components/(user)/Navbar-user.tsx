...
import { faBars, faXmark, faMagnifyingGlass, faCartShopping, faUser, faRightFromBracket, faBoxOpen, faGear, faChevronDown, faHeart } from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-1">
              ...
              <Link href="/user/wishlist" className="relative flex px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-600 hover:text-red-500 transition-colors" title="Wishlist">
                ...
                {wishlistCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 px-1 bg-red-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center">{wishlistCount > 99 ? "99+" : wishlistCount}</span>
                )}
              </Link>
        ...
        <div className="hidden md:block border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center overflow-x-auto">
              ...
              <Link href="/user/products" className="whitespace-nowrap px-4 py-3 text-sm font-semibold text-[#E85D04] border-b-2 border-transparent hover:underline">
                Lihat Semua
              </Link>
            </div>
          </div>
